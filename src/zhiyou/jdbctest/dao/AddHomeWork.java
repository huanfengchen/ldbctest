...
public class AddHomeWork {
    ...
    public static void findHomworkByNumno(int numno) throws SQLException {//传入学生的学号，查找该学生作业情况
        Connection conn = null;
        Statement stmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            sql = "select numno,name, homeworkid, answer,  score from homework h, persons s where s.numno=h.owner and  s.numno='" + numno + "'";
            rs = stmt.executeQuery(sql);// executeQuery会返回结果的集合，否则返回空值
            while (rs.next()) {
//                System.out.println(rs);
                System.out.println(rs.getInt(1) + "\t" + rs.getString(2) + "\t"
                        + rs.getInt(3) + "\t" + rs.getString(4)  + "\t" + rs.getInt(5)   );// 入如果返回的是int类型可以用getInt()
            }
...
//                System.out.println(rs);
    ...
    public static void teachernocorrect(String b) throws SQLException{//查找几号学生作业没批改
        Connection conn = null;
        Statement stmt = null;
        ResultSet rs = null;
        ...
        try {
            ...
            sql = "select distinct homeworkid, answer, owner, score from homework h where h.score is null and h.owner="+b;
            System.out.println("1111");
            rs = stmt.executeQuery(sql);// executeQuery会返回结果的集合，否则返回空值2
...
//                System.out.println(rs);
    ...
    public static void Teachercorrectwork(String a,String c,String d) throws SQLException{//查看没有批改的学生,
        Connection conn = null;
        Statement stmt = null;
        ResultSet rs = null;
        ...
        try {
         ...
         //   System.out.println("b="+b+"a="+a);
            ...
            sql = " update  homework h set score="+a+" where h.homeworkid="+c+" and h.owner="+d+";";
